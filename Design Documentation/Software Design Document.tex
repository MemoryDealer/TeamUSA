...
\section{Appendix A: Diagrams \& Figures}
	...
	\subsection{Top Down Iterative Refinement}
		\subsubsection{Component Diagram}
			\begin{center}
				\includegraphics[scale=0.6]{Top_down.png}
			\end{center}
	%%%
	\subsection{Dynamic Data Flow Analysis}
		\subsubsection{Flow Diagram}
			\begin{center}
				\includegraphics[scale=0.40,angle=90]{ddfFlow.pdf}
			\end{center}
		\subsubsection{Factored Diagram}
			\begin{center}
				\includegraphics[scale=0.40,angle=90]{ddfFactored.pdf}
			\end{center}
	%%%
	\subsection{Static Data Flow Analysis}
		\subsubsection{Data Structure Diagram}
			\begin{center}
				\includegraphics[scale=0.4]{Jackson1.png}
			\end{center}
		\subsubsection{Program Structure Diagram}
			\begin{center}
				\includegraphics[scale=0.4]{Jackson2.png}
			\end{center}
		\subsubsection{Nonprocedural Program Tasks \& Task Allocation}
			\begin{center}
				\includegraphics[scale=0.5]{Jackson34.png}
			\end{center}
	%%%
	\subsection{Object Oriented + Unified Modeling Language}
		\subsubsection{UML Diagram}
			\begin{center}
				\includegraphics[scale=0.27]{MainClasses.png}
			\end{center}
		\subsubsection{Actor Inheritance Sub-diagram}
			\begin{center}
				\includegraphics[scale=0.27]{Actors.png}
			\end{center}
		\subsubsection{Timing Diagrams}
			\paragraph{Handle Actor Event}
				\begin{center}
					\includegraphics[scale=0.3]{handle-actor-event.png}
				\end{center}
			\paragraph{Load Level}
				\begin{center}
					\includegraphics[scale=0.3]{load-level.png}
				\end{center}
			\paragraph{Main Loop}
				\begin{center}
					\includegraphics[scale=0.3]{main-loop.png}
				\end{center}
%
